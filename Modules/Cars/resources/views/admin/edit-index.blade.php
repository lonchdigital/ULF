                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-head mb-20">
                            <h4 class="card-head-title">{{ $carsPage->name }}</h4>
                        </div>

                        <form class="forms-sample" action="{{ route('car.index.page.update', ['page' => $carsPage]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <section>
                                ...
                                <div class="form-group">
                                    <x-admin.multilanguage-text-area
                                        ...
                                        :values="$carsPage->getTranslationsArray()"/>
                                </div>
                                <div class=form-group">
